...
import { profile, type KnowledgeChunk } from "./profile";
...
export function retrieveAnswer(query: string): RetrievalResult {
  ...
  if (tokens.length === 0) {
    return {
      answer:
        "Ask me something: my projects, ML systems, backend experience, AI/ML work, Python skills, what roles I'm looking for, or how to reach me.",
      sources: [],
      confident: false,
    };
  }
